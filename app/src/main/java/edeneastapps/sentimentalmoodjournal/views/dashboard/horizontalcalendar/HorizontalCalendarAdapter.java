...
public class HorizontalCalendarAdapter extends RecyclerView.Adapter<HorizontalCalendarAdapter.HorizontalCalendarViewHolder>{
    ...
    public HorizontalCalendarAdapter(Context context, HorizontalCalendarAdapter.OnDaySelectedListener onDaySelectedListener, OnEndReachedListener onEndReachedListener) {
